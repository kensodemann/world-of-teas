...
describe('service: encryption', function() {
  let mockBuffer;
  let mockCrypto;
  let mockHmac;
  ...
  describe('salt', function() {
    ...
    it('converts the byte buffer to a string', function() {
      const service = new Service();
      service.salt();
    ...
    it('returns the salt string', function() {
      const service = new Service();
  ...
  describe('hash', function() {
    it('creates a sha1 hmac', function() {
      const service = new Service();
    ...
    it('returns a hex digest of the hmac', function() {
